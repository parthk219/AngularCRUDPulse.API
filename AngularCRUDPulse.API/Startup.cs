...
namespace AngularCRUDPulse.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           options.UseSqlServer(Configuration.GetConnectionString("ConnKey")));
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "AngularCRUDPulse.API", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "AngularCRUDPulse.API v1"));
            }
